 ...
 * Значением this здесь является сам конструктор класса.
 ...
 * У нас может быть два одинаковых поля одновременно – приватное и публичное.
 ...
 * не используем примесь саму по себе, а используем её, 
 *      чтобы добавить функциональность другим классам.
