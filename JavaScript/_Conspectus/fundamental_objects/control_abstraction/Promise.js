...
promise.then(
  ...
  function (error) {
    /* обработает ошибку, но лучше использовать .catch() */
  }
);
...
Promise.all([sleep(2000), sleep(5000)]).then(() => {
  // сработает после всех промисов в массиве
  console.log('All promises');
});

Promise.race([sleep(2000), sleep(5000)]).then(() => {
  // сработает после первого промиса в массиве
  console.log('All promises');
});
...
/**
 * async
 * Оборачивает результат ф-ии в успешный промис
...
// await используется только внутри ф-ий, поэтому здесь обернём в IIFE:
(async () => {
